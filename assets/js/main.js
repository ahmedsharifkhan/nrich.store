    ...
    content.innerHTML =
      ...
      '<div class="qv-right">' +
        '<div class="qv-right-inner">' +
          ...
          /* social — NRICH profile links */
          '<div class="qv-social">' +
            '<a class="qv-social-icon qv-social-icon--fb" href="https://www.facebook.com/nrichbd" target="_blank" rel="noopener" aria-label="Facebook">' +
              '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>' +
            '</a>' +
            '<a class="qv-social-icon qv-social-icon--x" href="https://x.com/nrichstore" target="_blank" rel="noopener" aria-label="X">' +
