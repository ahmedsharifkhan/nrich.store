    ...
    content.innerHTML =
      ...
      '<div class="qv-right">' +
        '<div class="qv-right-inner">' +
          ...
          /* Wishlist + Order Now row */
          '<div class="qv-secondary-actions">' +
            '<button class="qv-wish-btn" type="button">' +
              '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>' +
              ' Add To Wishlist' +
            '</button>' +
            '<a href="' + (waPhone ? 'https://wa.me/' + waPhone + '?text=' + waMsg : base + '/products/' + slug + '/') + '" class="qv-order-btn" target="_blank" rel="noopener">Order Now</a>' +
          '</div>' +
          ...
          /* social share */
          '<div class="qv-social">' +
            '<a class="qv-social-icon qv-social-icon--fb" href="https://www.facebook.com/sharer/sharer.php?u=' + pageUrl + '" target="_blank" rel="noopener" aria-label="Facebook">' +
              '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>' +
            '</a>' +
            '<a class="qv-social-icon qv-social-icon--tw" href="https://twitter.com/intent/tweet?url=' + pageUrl + '&text=' + pageTxt + '" target="_blank" rel="noopener" aria-label="Twitter">' +
              '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>' +
            '</a>' +
            '<a class="qv-social-icon qv-social-icon--yt" href="https://youtube.com" target="_blank" rel="noopener" aria-label="YouTube">' +
              '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.96-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon fill="white" points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02"/></svg>' +
            '</a>' +
            '<a class="qv-social-icon qv-social-icon--li" href="https://linkedin.com" target="_blank" rel="noopener" aria-label="LinkedIn">' +
              '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>' +
            '</a>' +
            '<a class="qv-social-icon qv-social-icon--ig" href="https://instagram.com/nrich.store" target="_blank" rel="noopener" aria-label="Instagram">' +
